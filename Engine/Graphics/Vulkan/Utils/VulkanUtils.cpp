...
void TransitionImageLayoutImmediate(VkDevice device, VkCommandPool commandPool, VkQueue queue, VkImage image, VkImageAspectFlags aspectMask, VkImageLayout oldLayout, VkImageLayout newLayout) {

    VkCommandBuffer cmd = BeginSingleTimeCommands(device, commandPool);

    TransitionImageLayout(cmd, image, aspectMask, oldLayout, newLayout);

    EndSingleTimeCommands(device, commandPool, queue, cmd);

}

void TransitionImageLayout(VkCommandBuffer commandBuffer, RenderTarget& target, VkImageLayout newLayout) {

    TransitionImageLayout(
        commandBuffer,
        target.GetImage(),
        target.GetAspectMask(),
        target.GetLayout(),
        newLayout
    );
...
void TransitionImageLayout(VkCommandBuffer commandBuffer, VkImage image, VkImageAspectFlags aspectMask, VkImageLayout oldLayout, VkImageLayout newLayout) {
