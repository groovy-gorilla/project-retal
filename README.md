...
Retal Engine is inspired by the golden era of military flight simulators from the 1990s. The long-term objective is to provide a modern technical foundation for recreating the experience of classic titles while taking advantage of current graphics hardware and rendering techniques.
...
Project Retal and Retal Engine are names used by this project.
All rights to these project names are reserved by the author.
