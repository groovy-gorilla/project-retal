...
void TransitionImageLayout2(VkCommandBuffer commandBuffer, RenderTarget& target, VkImageLayout newLayout) {

    VkImageLayout oldLayout = target.GetLayout();
    ...
    barrier.subresourceRange.aspectMask = target.GetAspectMask();
    barrier.subresourceRange.baseMipLevel = 0;
    barrier.subresourceRange.levelCount = 1;
    barrier.subresourceRange.baseArrayLayer = 0;
    barrier.subresourceRange.layerCount = 1;
